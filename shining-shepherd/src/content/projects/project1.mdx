...
<figure>
  ...
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Bandit fails, so the pipeline blocks deployment before any infrastructure changes.</figcaption>
</figure>
...
<figure>
  <a href="/assets/bandit_report.png" target="_blank" rel="noopener">
    <img src="/assets/bandit_report.png" alt="Bandit JSON report with HIGH severity finding and file and line reference" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  </a>
...
<figure>
  ...
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">A detected secret blocks the release until it is fixed.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">The plan is reviewed before apply to prevent surprises.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">After every security gate passes, deployment succeeds.</figcaption>
</figure>
