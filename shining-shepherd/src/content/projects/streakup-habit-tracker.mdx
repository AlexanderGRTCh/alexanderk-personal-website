...
description: "A production Flutter app with 655 automated tests, behavioral psychology-driven engagement, and a complete monetization stack. Shipped on Google Play and the App Store."
thumbnail: "/assets/streakup-thumbnail.png"
tags: ["Flutter", "Dart", "Riverpod", "Hive", "RevenueCat", "AdMob", "iOS", "Android"]
demoUrl: "https://alexandergrtch.github.io/StreakUp/"
featured: true
clientLinks:
  - label: "Google Play"
    url: "https://play.google.com/store/apps/details?id=com.resolutiontracker.app"
  - label: "App Store"
    url: "https://apps.apple.com/app/streakup-habit-tracker/id6742748961"
---

StreakUp is a cross-platform habit tracker built with Flutter and shipped to real users on Google Play and the App Store. It supports daily and weekly recurring habits, one-off tasks, streak tracking with shield protection, milestone badges, and a 5-tone emotion-aware celebration system. The app uses Riverpod for state management, Hive for offline-first local storage, RevenueCat for subscriptions, and AdMob for ad monetization. With 655 automated tests across 34 test files, it demonstrates production-grade mobile development with comprehensive test coverage.
...
### Technical Explanation
Building a habit tracker that users actually stick with requires more than CRUD operations. It needs: (1) behavioral psychology hooks that make progress feel rewarding, (2) graceful handling of real-world disruptions like missed days and vacations, (3) a monetization system that respects free users while incentivizing upgrades, (4) offline-first data persistence with sync-ready architecture, and (5) comprehensive test coverage to prevent regressions in a codebase that spans UI, state management, notifications, and in-app purchases.
...
- **Created 145 streak-tiered micro-messages** that evolve with streak length: "It begins." (day 1) → "Not a fluke." (days 2-3) → "Legendary." (day 60+). Messages fade in with 6px slide-up animation.
...
- **Wrote 655 automated tests** across 34 test files covering: goal sorting, notification expiration, one-off integration, purchase/restore flow, weekly metrics, emotion mapping, celebration dispatching, streak calculation, milestone logic, shield activation, and all Phase 1.5 home screen features.
...
- 655 automated tests covering unit, widget, and integration scenarios with comprehensive edge case handling.
...
- **Testing**: 655 tests across 34 files (no mockito — manual mocks with Fake base class)
- **CI/CD**: GitHub Actions for test automation, manual Play Console/App Store Connect upload
- **Version**: 1.0.3+20 (current), package `com.AlexanderCH.habitracker2026`

## Links
- **Universal Link**: https://alexandergrtch.github.io/StreakUp/
- **Google Play**: https://play.google.com/store/apps/details?id=com.resolutiontracker.app
- **App Store**: https://apps.apple.com/app/streakup-habit-tracker/id6742748961
