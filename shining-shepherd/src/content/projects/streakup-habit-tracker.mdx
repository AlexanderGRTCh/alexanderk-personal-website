...
thumbnail: "/assets/streakup-home-screen.jpg"
...
<figure>
  <img src="/assets/streakup-home-screen.jpg" alt="Home screen with Today's Mission card, goal list, and weekly consistency dots" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Home screen with Today's Mission card, weekly consistency dots, and goal cards showing streaks and progress</figcaption>
</figure>

<figure>
  <img src="/assets/streakup-calendar.jpg" alt="Calendar view with success, missed, paused, and shielded days" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Calendar view showing check-in history with color-coded days and legend for success, missed, paused, and shielded states</figcaption>
</figure>

<figure>
  <img src="/assets/streakup-empty-state.jpg" alt="Empty state with identity framing and suggestion chips" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Empty state with identity framing: "You're about to start something real" with suggestion chips for quick goal creation</figcaption>
</figure>

<figure>
  <img src="/assets/streakup-app-store.jpg" alt="App Store listing showing StreakUp icon and tagline" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Live on the App Store: "Build Habits. Protect Streaks."</figcaption>
</figure>
