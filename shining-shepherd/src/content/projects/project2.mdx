...
<figure>
  <img src="/assets/MomentumBias.png" alt="Infographic comparing Fixed Bias Model (static 50%) vs Momentum-Based Bias Model" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <figcaption class="text-sm text-gray-600 dark:text-gray-400">Infographic comparing Fixed Bias Model (static 50%) vs Momentum-Based Bias Model</figcaption>
</figure>
...
<figure>
  <img src="/assets/1st.png" alt="Court view during a point with ball trail and bias bar" loading="lazy" class="w-full rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
...
<figure>
  <img src="/assets/Replay2.png" alt="Replay view 1" loading="lazy" class="inline-block w-1/2 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
  <img src="/assets/replay3.png" alt="Replay view 2" loading="lazy" class="inline-block w-1/2 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700" />
